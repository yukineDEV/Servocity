            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                <div class="login-form-container p-4">
                    ...
                    <form>
                        ...
                        <button type="button" class="btn btn-outline-dark mb-1 btn-login img-btn-login"> Sign in with Apple</button>
                        <p class="text-center">Don’t have an account? <a href="#" class="text-decoration-none">Sign Up</a></p>
                    </form>
                </div>
            </div>
        </div>
